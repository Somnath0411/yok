    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-section brand">
          <h2 className="footer-logo">Symbotz</h2>
        ...
        <div className="footer-section">
          <h3>COMPANY</h3>
          <ul>
            <Link to="/About" onClick={()=>window.scrollTo(0,0)}><li><a href="/about">About</a></li></Link>
            <Link to="/services" onClick={()=>window.scrollTo(0,0)}><li><a href="/services">Services</a></li></Link>
            <Link to="/Careers" onClick={()=>window.scrollTo(0,0)}><li><a href="/learn">Careers</a></li></Link>
            <Link to="/education" onClick={()=>window.scrollTo(0,0)}><li><a href="/learn">Education</a></li></Link>
            <Link to="/Contact" onClick={()=>window.scrollTo(0,0)}><li><a href="/contact">Contact us</a></li></Link>
          </ul>
        </div>
